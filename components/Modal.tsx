...
const Modal = ({ visible, setVisible }: ModalProps): JSX.Element => {
    ...
    const userInputhandling = (e: React.ChangeEvent<HTMLTextAreaElement>) =>
                    ...
                    <div className="flex flex-col bg-white shadow-lg rounded-xl">
                        ...
                        <div className="flex flex-col items-center w-full bg-gray-200">
                            <div className="flex flex-col items-center py-6 space-y-3">
                                ...
                                <div className="flex space-x-3">{createStarts()}</div>
                            </div>
                            <div className="flex flex-col w-3/4">
                                <textarea
                                    className="p-4 text-gray-500 resize-none rounded-xl"
                                    placeholder="Leave a message, if you want"
                                    value={userMessage}
                                    onChange={userInputhandling}
                                />
                                <button
                                    className="py-3 my-8 text-lg text-white bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl"
                                    onClick={() => submit()}>
                                    Rate now
                                </button>
                            </div>
